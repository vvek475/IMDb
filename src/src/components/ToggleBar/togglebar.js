        ...
        <div className={`toggleBar ${visibility ? 'active' : ''}`}>
            ...
            <div className="toggleBar__anchors">
                <div className="toggleBar__anchorlist">
                    <ul>
                        <Link to="/watchlist"><li>Streaming Now</li></Link>
                        <li>In Theatres</li>
                        <li>Trending</li>
                        <li>Box Office</li>
                        <li>Popular Shows</li>
